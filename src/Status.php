...
enum Status: int
{
     ...
     * This method returns a human-readable reason phrase corresponding to the status code.
     * It uses a match expression to return the appropriate phrase based on the enum case.
     *
     * @return string
